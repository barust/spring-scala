...
object BeanFactoryConversions {
	 ...
	 */
	implicit def beanFactoryWrapper(beanFactory: BeanFactory): RichBeanFactory =
	 ...
	 */
	implicit def listableBeanFactoryWrapper(beanFactory: ListableBeanFactory): RichListableBeanFactory =
